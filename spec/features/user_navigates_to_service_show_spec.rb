feature "User navigates to individual services show page." do
  background do
    ...
    @full_service = Fabricate(:service, name: "Food Place", category: @category, website: "www.foodplace.com", phone: "615-555-5555", description: "a place to get food stuff.", offered_services: "food for people that don't have any")
    visit root_path
    click_on "Services"
